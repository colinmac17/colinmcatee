...
site_url: https://colinmcatee.com/blog/announcements/why-I-am-here
category: Announcements
slug: why-I-am-here
author_image: https://prodrecruit-assets.s3.amazonaws.com/colin_headshot.jpg
---

![Hello there](https://i.redd.it/qj2fbx8tudi31.jpg "Hello There. General Kenobi.")
...
#### The transformation
I started learning how to code with [FreeCodeCamp](https://freecodecamp.org) in 2016, and have not looked back since. In 2016 I started my first job out of college as a consultant in downtown Chicago. I traveled Monday - Thursday every week and while it was exciting at first, I quickly realized I didn't want to do this forever. 
...
I was performing well and picking up topics (HTML, CSS, JavaScript, JQuery, Node, React, etc.) quickly thanks to my fantastic award winning instructor, [Mark Thompson](https://twitter.com/marktechson). I could write at least an entire post about how wonderful Mark is, both as a person and teacher.

At month three I started applying for junior developer positions and I eventually got one for a smaller Chicago SaaS Company called RIVS, now known as [InterviewStream](https://interviewstream.com). The initial interviews went well and the final interview went just ok. I was able to complete the initial programming challenge, but when I met with the CEO who gave me a more challenging algorithm challenge, I struggled. Luckily, they understood I was still very junior, and gave me the opportunity to go home and complete it by the next day. I spent hours [hacking on a solution](https://repl.it/@colinmac17/RivsHashInterview#main.js) and I eventually got an email that changed my life... I got the job!!!

#### My Career so far

In my three year career as a software engineer I have learned so much to the point where I have not only doubled my salary, but have been able to build an [entire SaaS product](https://productiverecruit.com) that makes money and has real customers on my own. I never would have thought I could grow this quickly, but it goes to show how important it is to truly enjoy what you do everyday. Work certainly isn't always fun, but I love building things with software, and I get to do that almost everyday.

Head over to the [home page of my site](https://colinmcatee.com) to learn more about my career, education, and skills.

## What's next?

I will continue to learn and share my journey with you. I will probably write openly about how I am growing Productive Recruit (at least on the technical side). I am planning on moving the platform to mobile eventually, and am planning to build a new API with Laravel and client with the Ionic Framework. Right now the platform is a web app built with the [TALL Stack](https://tallstack.dev), which is incredible btw. Until then, thank you for following along if you actually ready this far! ✌️